#
#  Be sure to run `pod spec lint Aves.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/Adrien Long"
  ...
  s.source       = { :git => "https://github.com/Bluezen/Aves.git", :commit => "cd5c3b1ffbdb0a0f27e0361b6c35abff274d6035" }
